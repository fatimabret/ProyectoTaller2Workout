...
namespace workout.CapaEntidad
{
    public class Entrenador : Usuario
    {
        ...
        public DateTime horario_disp { get; set; }
        public DateTime dias_disp { get; set; }
        public string detalles { get; set; }
        public int cupo { get; set; }
        //Constructor
        public Entrenador(string p_nombre, string p_apellido, int p_dni, string p_correo, string p_contrasena, DateTime p_horario_disp, DateTime p_dias_disp, string p_detalles, int p_cupo)
