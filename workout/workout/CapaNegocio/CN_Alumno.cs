...
namespace workout.CapaNegocio
{
    public class CN_Alumno
    {
        ...
        public int registrar(string p_nombre, string p_apellido, int p_dni, DateTime p_fecha_nac,string p_genero, string p_correo, string p_detalles)
        {
            //Crea un nuevo alumno y setea los datos
            Alumno alumno = new Alumno(p_nombre,p_apellido,p_dni,p_fecha_nac,p_genero,p_correo,p_detalles);
